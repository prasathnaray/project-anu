        ...
        <div className="">
            <ul className={`${buttonOpen === false ? "py-3 px-[7px]" : "py-5 px-8"}`}>
              ...
              <>
                ...
                <li className={`${data==="/schedules"? 'bg-[#8DC63F] rounded-xl p-[10px] text-white mb-1 mt-2': 'flex gap-5 hover:bg-[#8DC63F] hover:rounded-xl p-[10px] hover: text-white mb-1 mt-2'}`} onMouseDown={(e) => ripple.create(e, "dark", "circle")}><a href="/schedules" className={`${data==="/schedules"?'text-white flex gap-5': 'flex gap-5 text-gray-500'}`}><Calendar size={20} /><div className={`${buttonOpen === false ? 'hidden': 'text-md'}`}>Schedules</div></a></li>
