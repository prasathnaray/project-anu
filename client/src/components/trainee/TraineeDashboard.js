            ...
            <div className="grid grid-cols-3 gap-5">
              ...
              <div className="col-span-2 flex flex-col gap-4">
                ...
                <div className="border rounded-lg p-5 border-gray-300 bg-white">
                  ...
                  <div className="grid grid-cols-4 gap-3">
                    <ScoreBadge label="MS" value={msTotalAttempts} color="#8DC63F" subLabel={`MindSpark Attempts${msResourceCount > 0 ? ` (${msResourceCount} resources)` : ''}`} />
                    <ScoreBadge label="OB" value={obResources.length > 0 ? `${obCompleted}/${obResources.length}` : '—'} color="#f97316" subLabel="OB Booster" />
