...
//     (item) => item.resource_name?.startsWith("Test")
//   );
...
//   React.useEffect(() => {
//     const completedTest = testResources.find((t) => t.is_completed);
//     if (completedTest) {
//       setSelectedTestId(completedTest.resource_id);
//     }
//   }, [testResources]);
...
//       (test) => test.resource_id === selectedTestId
//     );
