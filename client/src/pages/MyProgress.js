...
const RESOURCES = {
  bpd_hc: [
    ...
    { id: 'r5',  name: 'Anatomical Landmarks of the Transthalamic Plane', type: 'resource',  topic: 'Anatomical Landmarks', done: true  },
    { id: 'r6',  name: 'Geometric shapes of key landmarks and their significance', type: 'resource', topic: 'Anatomical Landmarks', done: false },
    { id: 'r7',  name: 'MindSparks - Quiz',                     type: 'resource',  topic: 'Anatomical Landmarks', done: false },
    { id: 'r8',  name: 'Imaging the plane',                     type: 'resource',  topic: 'Imaging the Transthalamic Plane', done: true  },
    { id: 'r9',  name: 'Interaction - Fetal Head Scanning Activity', type: 'resource', topic: 'Imaging the Transthalamic Plane', done: false },
    { id: 'r10', name: 'MindSparks - Probe movements',          type: 'resource',  topic: 'Imaging the Transthalamic Plane', done: false },
    { id: 'r11', name: 'How to measure BPD',                    type: 'resource',  topic: 'Measurement',        done: false },
    { id: 'r12', name: 'How to measure HC',                     type: 'resource',  topic: 'Measurement',        done: false },
    { id: 'r13', name: 'Plane Acquisition Challenges and Common Errors', type: 'resource', topic: 'Pitfalls in Plane Acquisition and Measurement', done: false },
    { id: 'r14', name: 'MindSparks - Picture Pick',             type: 'resource',  topic: 'Pitfalls in Plane Acquisition and Measurement', done: false },
    { id: 'r15', name: 'Image Diagnosis',                       type: 'resource',  topic: 'Image Diagnosis',     done: false },
    { id: 'r16', name: 'Percentile Charts & Significance',      type: 'resource',  topic: 'Image Diagnosis',     done: false },
    { id: 'r17', name: 'BPD Chart',                             type: 'resource',  topic: 'Image Diagnosis',     done: false },
    { id: 'r18', name: 'HC Chart',                              type: 'resource',  topic: 'Image Diagnosis',     done: false },
    { id: 'r19', name: 'MindSparks - Yes/No',                   type: 'resource',  topic: 'Image Diagnosis',     done: false },
    { id: 'r20', name: 'Image Selection',                       type: 'resource',  topic: 'OB Boosters',         done: false },
    { id: 'r21', name: 'Picture Pick',                          type: 'resource',  topic: 'OB Boosters',         done: false },
    { id: 'r22', name: 'Visual Recognition',                    type: 'resource',  topic: 'OB Boosters',         done: false },
    { id: 'r23', name: 'True/False',                            type: 'resource',  topic: 'OB Boosters',         done: false },
    { id: 'r24', name: 'Word Search',                           type: 'resource',  topic: 'OB Boosters',         done: false },
  ...
  ac: [
    { id: 'ac_r1',  name: 'AC Introduction',                                      type: 'resource', topic: 'Fetal Abdomen', done: false },
    { id: 'ac_r2',  name: 'Transabdominal plane & Abdominal circumference',       type: 'resource', topic: 'Fetal Abdomen', done: false },
    { id: 'ac_r3',  name: 'Significance',                                         type: 'resource', topic: 'Fetal Abdomen', done: false },
    { id: 'ac_r4',  name: 'Geometric shapes of key landmarks and their significance', type: 'resource', topic: 'Anatomical Landmarks', done: false },
    { id: 'ac_r5',  name: 'MindSparks - Quiz',                                     type: 'resource', topic: 'Anatomical Landmarks', done: false },
    { id: 'ac_r6',  name: 'Imaging the plane',                                     type: 'resource', topic: 'Imaging the Plane', done: false },
    { id: 'ac_r7',  name: 'MindSparks - Probe movements',                          type: 'resource', topic: 'Imaging the Plane', done: false },
    { id: 'ac_r8',  name: 'Measurement',                                           type: 'resource', topic: 'Measurement', done: false },
    { id: 'ac_r9',  name: 'Interaction - Plane orientation and measurement',        type: 'resource', topic: 'Measurement', done: false },
    { id: 'ac_r10', name: 'MindSparks - Picture Pick',                             type: 'resource', topic: 'Measurement', done: false },
    { id: 'ac_r11', name: 'Plane Acquisition Challenges and Common Errors',         type: 'resource', topic: 'Pitfalls in Plane Acquisition and Measurement', done: false },
    { id: 'ac_r12', name: 'MindSparks - Picture Pick',                             type: 'resource', topic: 'Pitfalls in Plane Acquisition and Measurement', done: false },
    { id: 'ac_r13', name: 'AC chart',                                              type: 'resource', topic: 'Image Diagnosis', done: false },
    { id: 'ac_r14', name: 'MindSparks - True/False',                               type: 'resource', topic: 'Image Diagnosis', done: false },
    { id: 'ac_r15', name: 'Crossword puzzle',                                      type: 'resource', topic: 'OB Boosters', done: false },
    { id: 'ac_r16', name: 'True/False',                                            type: 'resource', topic: 'OB Boosters', done: false },
    { id: 'ac_r17', name: 'Picture Pick',                                          type: 'resource', topic: 'OB Boosters', done: false },
  ...
  fl: [
    ...
    { id: 'fl_r4',  name: 'Geometric shapes of key landmarks and their significance', type: 'resource', topic: 'Anatomical Landmarks', done: false },
    { id: 'fl_r5',  name: 'Interaction - Femur Bone',                          type: 'resource', topic: 'Anatomical Landmarks', done: false },
    { id: 'fl_r6',  name: 'MindSparks - Quiz',                                 type: 'resource', topic: 'Anatomical Landmarks', done: false },
    { id: 'fl_r7',  name: 'Imaging the plane',                                 type: 'resource', topic: 'Imaging the Plane', done: false },
    { id: 'fl_r8',  name: 'MindSparks - Probe movements',                      type: 'resource', topic: 'Imaging the Plane', done: false },
    { id: 'fl_r9',  name: 'Measurement of  FL',                                type: 'resource', topic: 'Measurement', done: false },
    { id: 'fl_r10', name: 'MindSparks - Picture Pick',                         type: 'resource', topic: 'Measurement', done: false },
    { id: 'fl_r11', name: 'Plane Acquisition Challenges and Common Errors',     type: 'resource', topic: 'Pitfalls in Plane Acquisition and Measurement', done: false },
    { id: 'fl_r12', name: 'MindSparks - Picture Pick',                         type: 'resource', topic: 'Pitfalls in Plane Acquisition and Measurement', done: false },
    { id: 'fl_r13', name: 'FL chart',                                          type: 'resource', topic: 'Image Diagnosis', done: false },
    { id: 'fl_r14', name: 'MindSparks - True/False',                           type: 'resource', topic: 'Image Diagnosis', done: false },
    { id: 'fl_r15', name: 'Picture Pick',                                      type: 'resource', topic: 'OB Boosters', done: false },
    { id: 'fl_r16', name: 'True/False',                                        type: 'resource', topic: 'OB Boosters', done: false },
