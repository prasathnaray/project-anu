...
const RESOURCES = {
  ...
  ac: [
    ...
    { id: 'ac_r5',  name: 'Mind Sparks - Quiz',                                    type: 'resource', topic: 'Anatomical Landmarks', done: false },
    { id: 'ac_r6',  name: 'Imaging the plane',                                     type: 'resource', topic: 'Imaging the Plane', done: false },
    { id: 'ac_r7',  name: 'Mind Sparks - Probe Movements',                         type: 'resource', topic: 'Imaging the Plane', done: false },
    ...
    { id: 'ac_r10', name: 'Mind Sparks - Picture Pick',                            type: 'resource', topic: 'Measurement', done: false },
    ...
    { id: 'ac_r12', name: 'Mind Sparks - Picture Pick',                            type: 'resource', topic: 'Pitfalls in Plane Acquisition and Measurement', done: false },
    { id: 'ac_r13', name: 'AC chart',                                              type: 'resource', topic: 'Image Diagnosis', done: false },
    { id: 'ac_r14', name: 'Mind Sparks - True/False',                              type: 'resource', topic: 'Image Diagnosis', done: false },
