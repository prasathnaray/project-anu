                                ...
                                <div className="px-10 py-8 w-full max-w-[1800px] mx-auto">
                                            ...
                                            <div className="mt-5 bg-white rounded px-8 py-10 ">
                                                ...
                                                <div className="grid grid-cols-2 items-center my-5">
                                                        ...
                                                        /></div>
                                                        <div className="flex justify-end items-center"><a href="/trainee/add" className="bg-[#8DC63F] hover:bg-[#8DC63F] text-white rounded px-10 py-3 font-semibold text-sm transition-all ease-in-out">Create Batch</a></div>
                                                </div>
