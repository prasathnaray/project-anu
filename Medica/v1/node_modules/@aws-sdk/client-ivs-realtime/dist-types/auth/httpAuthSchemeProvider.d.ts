 ...
 * @internal
 */
export interface IVSRealTimeHttpAuthSchemeParametersProvider extends HttpAuthSchemeParametersProvider<IVSRealTimeClientResolvedConfig, HandlerExecutionContext, IVSRealTimeHttpAuthSchemeParameters, object> {
}
/**
 * @internal
 */
export declare const defaultIVSRealTimeHttpAuthSchemeParametersProvider: (config: IVSRealTimeClientResolvedConfig, context: HandlerExecutionContext, input: object) => Promise<IVSRealTimeHttpAuthSchemeParameters>;
/**
 * @internal
 */
